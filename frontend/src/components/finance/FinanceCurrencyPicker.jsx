...
const common = ["USD", "EUR", "GBP", "INR", "AUD", "CAD", "JPY", "CHF", "SEK", "NZD"];
...
export default function FinanceCurrencyPicker({ current = "USD", onChange }) {
  ...
  return (
    <label className="text-sm text-stone-600 dark:text-stone-300 flex items-center gap-2">
      Currency:
      <select className="px-2 py-1 rounded bg-stone-100 dark:bg-stone-800" defaultValue={current} onChange={handleChange} disabled={saving}>
        {common.map((c) => (
