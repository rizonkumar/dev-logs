      ...
      <Droppable droppableId={columnId}>
        {(provided, snapshot) => (
          <div
            ...
            className={`flex-1 p-3 transition-colors rounded-b-xl ${
                  ...
                  >
                    {(provided) => (
                      <div
                        ...
                        className="group relative p-3 rounded-lg bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-700 shadow-sm hover:shadow-md hover:border-stone-300 dark:hover:border-stone-600 transition-all cursor-pointer mb-3"
