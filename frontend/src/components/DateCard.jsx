    ...
    <>
      ...
      <div className="group relative">
        ...
        >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                  ...
                  {relativeDate === "Today" && (
                    <div className="absolute inset-0 w-7 h-7 rounded-md bg-blue-500/20" />
                  )}
                </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                {/* View Mode Toggle */}
                {isExpanded && (
                  <div className="flex items-center space-x-1 bg-stone-100/80 dark:bg-stone-800/80 rounded-lg p-0.5 border border-stone-200/50 dark:border-stone-700/50">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        setViewMode("timeline");
                      }}
                      className={`px-2 py-1 rounded text-xs transition-all duration-300 font-medium ${
                        viewMode === "timeline"
          ...
          >
            <div className="p-4 bg-gradient-to-br from-stone-50/80 to-white/80 dark:from-stone-900/60 dark:to-stone-800/60">
